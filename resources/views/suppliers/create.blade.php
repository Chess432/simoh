    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-8">
                <form action="{{ route('supplier.supplier.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="suppliers_name" name="suppliers_name" placeholder="Suppliers Name">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="item_purchased">Item purchased</label>
                                <input type="text" class="form-control" id="item_purchased" name="item_purchased" placeholder="Item purchased">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="usd" name="usd" placeholder="Amount USD">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="zwd" name="zwd" placeholder="Amount ZWD">
                            </div>
                        </div>
